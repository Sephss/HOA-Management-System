...
public class FirebaseTicketMaintenanceManager {
    private static DatabaseReference getDatabase() {
        return FirebaseDatabase.getInstance().getReference("TicketCounterMaintenance");
    }
    public static void generateTicketNumber(TicketMaintenanceCallback callback) {
